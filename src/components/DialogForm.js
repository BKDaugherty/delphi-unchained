...
const ContractDialogMethodForm = ({
    title,
    description,
    handleSubmit,
    handleClose,
        ...
        <DialogActions>
            {fields ? (
                <Button
                    color="secondary"
                    onClick={reset}
                    disabled={fields && (pristine || submitting)}
                >
          Reset
                </Button>
            ) : null}
...
const DialogForm = props => (
    <DialogButton
        label={props.label}
        DialogContentComponent={reduxForm({
            form: props.dialogProps.formName,
            validate: props.dialogProps.validate
        })(ContractDialogMethodForm)}
