...
const ValidatorTransformer = transformer => ({ value, error }) => ({
...
export const validNumber = ValidatorGenerator(
    value => isNaN(Number(value)),
    Errors.IsNumber
)
export const validPositive = ValidatorGenerator(
    value => isLessThan(0)(Number(value)),
    Errors.IsPositiveNumber
)
export const validInteger = ValidatorGenerator(
    value => !Number.isInteger(Number(value)),
    Errors.IsInteger
)
export const validTimeInTheFuture = ValidatorGenerator(
    value => isInThePast(Number(value)),
    Errors.IsInFuture
)
export const validEthAddress = ValidatorGenerator(
    isInvalidEthereumAddress,
    Errors.IsEthereumAddress
)
export const validationValueToNumber = ValidatorTransformer(Number)

export const ValidateRequiredAddress = CombinedValidator(
    validEthAddress,
    validRequired
)
export const ValidateRequiredPositiveInteger = CombinedValidator(
    validRequired,
    validNumber,
    validPositive,
    validInteger
)
export const ValidateRequiredPositiveNumber = CombinedValidator(
    validRequired,
    validNumber,
    validPositive
)
export const ValidateRequiredTimeInFuture = CombinedValidator(
    validRequired,
    validNumber,
    validInteger,
