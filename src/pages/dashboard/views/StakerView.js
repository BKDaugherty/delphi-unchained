...
const AddButton = props => (
    <Button
        ...
        color="primary"
        aria-label="add"
        className={props.classes.absoluteButton}
    >
        <AddIcon />
    </Button>
)
...
const NoStakesView = () => (
    <NoItems
        title="You don't have anything staked"
        text="To gain the trust of others, you can create a stake by pressing the button in the bottom right corner of the screen."
    />
)

class StakerView extends React.Component {
  render = () => {
      const addAction = CreateDelphiStakeForm(
      ...
      return (
          <div>
              {this.state.stakes.length === 0 ? (
                  ...
                  <StakeFeed stakes={this.state.stakes} />
              )}
